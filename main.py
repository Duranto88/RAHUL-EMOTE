...
async def MaiiiinE():
    Uid , Pw = '4225354052','AEC611B298D7E2ABA9257D10F7E404BEA035779A0F5E49555DBA6DC973FFC34D'
    ...
    os.system('clear')
    print(render('DURANTO', colors=['white', 'green'], align='center'))
    print('')
